...
if(URL.indexOf("api.php/app")!=-1||URL.indexOf("xgapp")!=-1){
    ...
    "&class=筛选class&area=筛选area&lang=筛选lang&year=筛选year&by=排序&limit=18&page=#PN#&apikey=682511af0fc5aebe56cb01dad194aa7e&keytime="+Ktimes;
}else if(URL.indexOf("豆瓣片单")!=-1){
    ...
    for(var i=0;i<分类.length;i++){
        ...
        for(var j=0;j<列表.length;j++){
            ...
            if(URL.indexOf("xgapp")!=-1||URL.indexOf("api.php/app/")!=-1||URL.indexOf(".vod")!=-1){
                ...
                }else if(URL.indexOf("8.142.23.147")||URL.indexOf("zjj.life")!=-1||URL.indexOf("yhzy")!=-1||URL.indexOf("zhenfy")!=-1||URL.indexOf("cztv")!=-1||URL.indexOf("1.14.63.101")!=-1||URL.indexOf("fit:8")!=-1||URL.indexOf("diliktv.xyz")!=-1||URL.indexOf("ppzhu.vip")!=-1||URL.indexOf("api.8d8q.com")!=-1||URL.indexOf("haokanju1.cc")!=-1||URL.indexOf("cztv")!=-1){
